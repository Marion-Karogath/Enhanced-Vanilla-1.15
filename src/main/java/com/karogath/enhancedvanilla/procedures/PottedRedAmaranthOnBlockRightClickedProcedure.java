...
public class PottedRedAmaranthOnBlockRightClickedProcedure extends EnhancedvanillaModElements.ModElement {
	public PottedRedAmaranthOnBlockRightClickedProcedure(EnhancedvanillaModElements instance) {
		super(instance, 222);
	}
