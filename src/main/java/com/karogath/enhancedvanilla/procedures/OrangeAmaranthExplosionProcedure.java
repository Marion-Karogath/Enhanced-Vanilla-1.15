...
public class OrangeAmaranthExplosionProcedure extends EnhancedvanillaModElements.ModElement {
	public OrangeAmaranthExplosionProcedure(EnhancedvanillaModElements instance) {
		super(instance, 218);
	}
