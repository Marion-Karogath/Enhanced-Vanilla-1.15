...
public class TEMPCrateGUIGui extends EnhancedvanillaModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TEMPCrateGUIGui(EnhancedvanillaModElements instance) {
		super(instance, 297);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("temp_crate_gui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("enhancedvanilla:textures/temp_crate_gui.png");
		@Override
