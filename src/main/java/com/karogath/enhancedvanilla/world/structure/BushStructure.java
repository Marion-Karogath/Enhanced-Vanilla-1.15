...
public class BushStructure extends EnhancedVanillaElements.ModElement {
	public BushStructure(EnhancedVanillaElements instance) {
		super(instance, 241);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 700000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("enhancedvanilla", "bush1"));
						if (template == null)
							return false;
