...
public class Bush1Structure extends EnhancedVanillaElements.ModElement {
	public Bush1Structure(EnhancedVanillaElements instance) {
		super(instance, 242);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 700000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("enhancedvanilla", "bush2"));
						if (template == null)
							return false;
