...
public class Shrub2Structure extends EnhancedVanillaElements.ModElement {
	public Shrub2Structure(EnhancedVanillaElements instance) {
		super(instance, 244);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 550000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("enhancedvanilla", "small_shrub2"));
						if (template == null)
							return false;
