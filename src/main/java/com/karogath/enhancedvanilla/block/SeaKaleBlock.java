...
public class SeaKaleBlock extends EnhancedvanillaModElements.ModElement {
	@ObjectHolder("enhancedvanilla:sea_kale")
	public static final Block block = null;
	public SeaKaleBlock(EnhancedvanillaModElements instance) {
		super(instance, 84);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(KaleItem.block, (int) (2)));
		}
